  ...
  return (
    <div>
      ...
      <footer className={toDoList.length === 0 ? "invisible" : "footer"}>
        <span className="todo-count"><strong>{todoCount}</strong> items left</span>
        ...
        <button className={todoCompleted === 0 ? "invisible" : "clear-completed"} onClick={clearCompleted}>Clear completed</button>
      </footer>
    </div>
